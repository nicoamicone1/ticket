...
export const TicketDetailPage: React.FC = () => {
  ...
  const { estimateTicket, approveTicket, rejectTicket, startTicket, resolveTicket, deleteTicket, isMutating } = useTickets();
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.error(getErrorMessage(err, 'Error al eliminar el ticket'));
      throw err; // mantiene el modal abierto para reintentar
    }
  };
  ...
  return (
    <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <Card style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            {canDelete && (
              <div style={{ borderTop: '1px solid var(--color-border)', paddingTop: '16px' }}>
                <Button variant="danger" fullWidth onClick={() => setIsDeleteOpen(true)} disabled={isMutating} icon={<Trash2 size={16} />}>
                  Eliminar Ticket
                </Button>
      ...
      <ConfirmModal
        ...
        message="¿Seguro que querés eliminar este ticket? Se borrarán sus adjuntos, comentarios y actividad. Esta acción no se puede deshacer."
